...
TraxanosHD::Images::Icon.new code: '', foreground: :foreground, filename: "extensions/movie_default.png", height: 20, width: 20, size: 18, background: :background, x: 0, y: 2
TraxanosHD::Images::Icon.new code: '', foreground: :foreground, filename: "extensions/movie_unwatched.png", height: 20, width: 20, size: 18, background: :background, x: 0, y: 2
TraxanosHD::Images::Icon.new code: '', foreground: :orange, filename: "extensions/movie_watching.png", height: 20, width: 20, size: 18, background: :background, x: 0, y: 2
TraxanosHD::Images::Icon.new code: '', foreground: :foreground, filename: "extensions/movie_cut.png", height: 20, width: 20, size: 18, background: :background, x: 0, y: 2
TraxanosHD::Images::Icon.new code: '', foreground: :green, filename: "extensions/movie_finished.png", height: 20, width: 20, size: 18, background: :background, x: 0, y: 2
TraxanosHD::Images::Icon.new code: '', foreground: :red, filename: "extensions/movie_rec.png", height: 20, width: 20, size: 18, background: :background, x: 0, y: 2
TraxanosHD::Images::Icon.new code: '', foreground: :red, filename: "extensions/movie_recrem.png", height: 20, width: 20, size: 18, background: :background, x: 0, y: 2
...
TraxanosHD::Images::Icon.new code: '', foreground: :foreground, filename: "skin_default/icons/movie_new.png", height: 20, width: 20, size: 18, background: :background, x: 0, y: 2
TraxanosHD::Images::Icon.new code: '', foreground: :blue, filename: "skin_default/icons/movie_start.png", height: 20, width: 20, size: 18, background: :background, x: 0, y: 2
TraxanosHD::Images::Icon.new code: '', foreground: :foreground, filename: "skin_default/icons/movie_select.png", height: 20, width: 20, size: 18, background: :background, x: 1, y: 2
TraxanosHD::Images::Icon.new code: '', foreground: :green, filename: "skin_default/icons/movie_seen.png", height: 20, width: 20, size: 18, background: :background, x: 0, y: 2
TraxanosHD::Images::Icon.new code: '', foreground: :red, filename: "skin_default/icons/movie_rec.png", height: 20, width: 20, size: 18, background: :background, x: 0, y: 2
