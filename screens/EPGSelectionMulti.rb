...
#   xml.widget position: "867,321", size: "356,24", valign: :center, halign: :center, backgroundColor: :backgroundAccent, foregroundColor: :foregroundAccent, render: "Label", source: "Service", transparent: 1, font: "Normal; 18", noWrap: 1, zPosition: 10 do
#     xml.convert "Name", type: "ServiceName"
#   end

#   xml.widget position: "867,363", size: "356,255", valign: :top, halign: :left, backgroundColor: :backgroundAccent, foregroundColor: :foregroundAccent, render: "VRunningText", source: "Event", transparent: 1, font: "Normal; 18", options: "movetype=running,startpoint=0,direction=top,steptime=90,repeat=2,always=0,startdelay=5000,wrap", zPosition: 10 do
#     xml.convert "ExtendedDescription", type: "EventName"
#   end

#   xml.eLabel position: "1151,645", size: "72,30", backgroundColor: :foregroundAccent, foregroundColor: :backgroundAccent, text: "MENU", font: "Normal; 20", valign: :center, halign: :center, noWrap: 1
