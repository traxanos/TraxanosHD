...
TraxanosHD::Screen.new(xml, :SimpleChannelSelection, "Channel selection") do
  ...
  main do
    ...
    widget do
      ...
      custom "serviceInfoFont", "Normal; #{TraxanosHD.default_font_size}"
      custom "serviceNameFont", "Normal; #{TraxanosHD.default_font_size}"
      custom "serviceNumberFont", "Normal; #{TraxanosHD.default_font_size}"
